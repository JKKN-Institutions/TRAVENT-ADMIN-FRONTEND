    ...
    const fetchRoutes = async () => {
      ...
      try {
        const response = await axios.get(
          `http://localhost:3000/api/bus/view-routes/${institutionDetails.institutionId}`
        );
          ...
          <div className="view-routes-content">
            ...
            <div className="search-bar-container">
              ...
              <div className="route-actions">
                ...
                <button className="delete-route-button">✕ Delete A Route</button>
              </div>
            </div>
...
{routeDetails &&(
  <>
      ...
      {showRouteDetails && selectedRoute && (
        <RouteDetails route={selectedRoute} onBack={handleBackClick} institutionId={routeDetails.institutionId}/>
      )}
    </>
  );
};
